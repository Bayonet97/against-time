...
public class PlayerMovement : MonoBehaviour
{
    ...
    //    // Move senteces
    //    GetComponent<Rigidbody2D>().velocity = new Vector2(Mathf.Lerp(0, Input.GetAxis("Vertical") * curSpeed, 0.8f),
    //                                         Mathf.Lerp(0, Input.GetAxis("Vertical") * curSpeed, 0.8f));
    //}

    private void rotatePlayerObjectY(int yAxis)
    {
        playerObject.transform.eulerAngles = new Vector3(0, yAxis, 0);
    }
}
